...
#ifndef _SAWYER_HARDWARE_INTERFACE___SHARED_JOINT_INTERFACE_H_
#define _SAWYER_HARDWARE_INTERFACE___SHARED_JOINT_INTERFACE_H_
...
#endif /* _SAWYER_HARDWARE_INTERFACE___SHARED_JOINT_INTERFACE_H_ */
